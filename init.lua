...
minetest.register_node("smelter:smelter", {
	description = "Smelter",
	tiles = {"smelter_smelter_top.png", "smelter_smelter_side.png", "smelter_smelter_side.png",
...
minetest.register_craftitem("smelter:iron_ingot", {
	description = "Iron Ingot",
	inventory_image = "smelter_iron_ingot.png",
})
